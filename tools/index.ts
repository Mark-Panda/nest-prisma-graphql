...
async function autoGenerated() {
    ...
    for (const modelItem of schema.list) {
        if (modelItem.type === 'model') {
            ...
            // 驼峰单词
            const camelCaseModel = camelCase(modelItem.name);
            ...
            writeFileSync(
                ...
                export class ${modelName}Resolver {
                    ...
                    async ${lowerModel}(
                        ...
                        //@ts-ignore
                        return await prisma.${camelCaseModel}.findUnique(args);
                    }
                    ...
                    async ${lowerModel}First(
                        ...
                        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                        //@ts-ignore
                        return await prisma.${camelCaseModel}.findFirst(args);
                    }
                    ...
                    async ${pluralName}(
                        ...
                        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                        //@ts-ignore
                        return await prisma.${camelCaseModel}.findMany(args);
                    }
                    ...
                    async createOne${modelName}(
                        ...
                        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                        //@ts-ignore
                        return await prisma.${camelCaseModel}.create(args);
                    }
                    ...
                    async updateOne${modelName}(
                        ...
                        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                        //@ts-ignore
                        return await prisma.${camelCaseModel}.update(args);
                    }
                    ...
                    async upsertOne${modelName}(
                        ...
                        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                        //@ts-ignore
                        return await prisma.${camelCaseModel}.upsert(args);
                    }
                    ...
                    async deleteOne${modelName}(
                        ...
                        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                        //@ts-ignore
                        return await prisma.${camelCaseModel}.delete(args);
                    }
                    ...
                    async ${lowerModel}Aggregate(
                        ...
                        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                        //@ts-ignore
                        return await prisma.${camelCaseModel}.aggregate(args);
                    }
                    ...
                    async ${lowerModel}GroupBy(
                        ...
                        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                        //@ts-ignore
                        return await prisma.${camelCaseModel}.groupBy(args);
                    }
                    ...
                    async createMany${pluralName}(@Args() args: CreateMany${modelName}Args): Promise<any> {
                        ...
                        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                        //@ts-ignore
                        const result = await prisma.${camelCaseModel}.createMany(args);
                        return result;
                    }
                    ...
                    async updateMany${pluralName}(@Args() args: UpdateMany${modelName}Args): Promise<any> {
                        ...
                        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                        //@ts-ignore
                        return await prisma.${camelCaseModel}.updateMany(args);
                    }
                    ...
                    async deleteMany${pluralName}(@Args() args: DeleteMany${modelName}Args): Promise<any> {
                        ...
                        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                        //@ts-ignore
                        return await prisma.${camelCaseModel}.deleteMany(args);
                    }
                }
